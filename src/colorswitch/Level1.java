 ...
 * Représente le premier niveau du jeu
 */
public class Level1 extends Level {
     ...
     * @param player
     */
    public Level1(double screenWidth, double screenHeight, Player player) {
        super(screenWidth, screenHeight, player);

        double x = screenWidth / 2;

        // Création des obstacles
        Square obstacle1 = new Square(x, 0.75 * screenHeight, 30);
